        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <form ng-submit="addToCart()">
                    <!-- <div id="accordion" class="box-shadow repair-field white-bg ">
                        <div class="card box-shadow white-bg">
                            <div class="card-header service-select white-bg" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <h5 class="mb-0">
                                    <a class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Select Services</a>
                                </h5>
                            </div>
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="card card-body">
                            <div class="form-check" ng-repeat="service in services">
                                <input type="checkbox" class="form-check-input" id="service_checkbox_{{service.service_id}}" ng-click="ShowHide(service.service_id,service.service_cost)">
                                <label id="service_checkbox_{{service.service_id}}" class="form-check-label" for="service_checkbox_{{service.service_id}}">{{service.service_name}} ${{service.service_cost}}</label>
                    ...
                    <br>
                    <button type="submit" class="btn button repair-button">ADD TO CART</button>
                </form>
            </div>
        </div>
